...
control MyIngress(inout headers hdr,
    ...
    action send_pmu_to_control_plane() {
        ...
        R1.write(0, meta.jpt_packet.fracsec0);
        R1.write(1, meta.jpt_packet.fracsec1);
        R1.write(2, meta.jpt_packet.fracsec2);
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            ...
            if(hdr.pmu.stat == (bit<16>)0x0)
            {
              ...
              if(temp_soc == 0)
              {
                temp_soc = (bit<32>)1390950013;
                temp_frac_sec = (bit<32>)617000;
                soc_regs.write(0, temp_soc);
                frac_sec_regs.write(0, temp_frac_sec);
              }
